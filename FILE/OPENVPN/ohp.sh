...
cd 
wget -O /usr/local/bin/ohp "https://raw.githubusercontent.com/fsteamID/InstallerPremiumSSH/main/FILE/OPENVPN/ohp"
...
[Unit]
Description=Direct Squid Proxy For OpenVPN TCP By Firdaus Siregar
Documentation=https://s.id/fsteamcyber
